 ...
 **/
abstract class karmaDataDesign extends PHPUnit_Extensions_Database_TestCase {
	/**
	...
	public final function getDataSet() {
		...
		$dataset->addTable("member");
		$dataset->addTable("profile");
		$dataset->addTable("message");
		$dataset->addTable("need");
		$dataset->addTable("karma");
	...
	public final function getConnection() {
		...
		if($this->connection === null) {
			...
			$config = readConfig("/etc/apache2/capstone-mysql/karma.ini");
