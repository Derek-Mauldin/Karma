...
echo '<div xmlns:dc="http://purl.org/dc/elements/1.1/" class="regularitem"></div>

<div xmlns:dc="http://purl.org/dc/elements/1.1/" class="regularitem" id="panel-wrapper">
            <div class="itemtitle">
               <h4 class="listing-title">
                  <i class="fa fa-times pull-right"></i><span class="request">REQUEST</span>&nbsp;Soccer Coach
               </h4><!--/.listing-title-->
            </div><!--/.panel-heading-->
            <div class="itemposttime">
               <span>Posted: </span>Thu, Dec 10, 2015 </div>
