...
window.onload = function() {
	setTimeout(function() {
		...
		var promos = document.querySelectorAll(".l0kut");
		var isblock = 0;
...
//          promo.style.cssText = 'display:none !important';
				promo.innerHTML = '<a href="https://www.bidnapper.com/?refuser=danstools" ><div id="l0kut2" style="background-color:#FCFCFC;width: 728px;height:90px;padding:10px;border:1px solid #cccccc;text-align:left;">\
...
<div id="l0kut2" style="background-color:#FCFCFC;width: 728px;height:90px;padding:10px;border:1px solid #cccccc;text-align:left;">\
