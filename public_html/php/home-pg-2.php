	...
	<!-------------Brand and toggle for better mobile display--------------------->
						...
						<button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#navbar-collapse-2" aria-expanded="false" aria-controls="navbar">
								...
								<div class="nav-logo" href="#">
									<a class="nav-logo animate" href="#"><img class="nav-logo animate" src="../img/orange-robot-logo-sm.png"></a>
								</div>
							</div>
			...
			<!--this is the sidebar-->
			<div class="container" id="side-panel">
				<div class="row">
					<section class="side-panel panel panel-fixed">
						<div class="col-md-4 hidden-xs hidden-sm" id="sidePanel">
							...
							<ul>
								...
								<li><br></li>
								<li><br></li>
								<li><a href="#Profile">Daily Feed</a></li>
								<li><br></li>
