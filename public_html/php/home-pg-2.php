...
<html lang="en">
	<head>
		...
		<link type="text/css" href="../lib/css/side-panel-2.css" rel="stylesheet"/>
	...
	<body class="sfooter">
		<div class="sfooter-content">
					...
					<div class="container-fluid">
						<div class="navbar-header">
							...
							<a class="navLogo" href="#">
								<img id="navLogo" src="./../img/robot-logo.png"
							</a>
						</div>
					</div>
					<div id="navbar" class="navbar-collapse collapse">
						...
						<div class="col=md-4">
							<ul class="nav navbar-nav navbar-right" id="sidebar">
								<li id="brand"><a href="#">Kismet</a></li>
			...
			<!--is is the sidebar-->
								<div class="container">	<!--this is the sidebar-->
									<div class="side-panel">
										<div class="row">
											<section class="side-panel panel panel-fixed">
												<div class="col-md-4 hidden-xs hidden-sm" id="sidePanel">

													<ul>
														<li class="sideLink"><br></li>
														<li><br></li>
														<li><br></li>
														<li><a href="#">Home</a></li>
														<li><br></li>
						...
						<div class="feed wrapper">
							<div class="col-md-8">
								<div class="panel-wrapper">
									<div class=<link type="text/css" href="../../lib/css/navbar.css" rel="stylesheet">
										<link type="text/css" href="../lib/css/side-panel-2.css" rel="stylesheet">"panel-heading">
										<p><i class="fa fa-times"></i><span>REQUEST</span>&nbsp;Soccer Coach</p>
									</div>
								</div>
								<div class="panel-info">
									...
									<div class="center">One of a group of parents forming a club soccer team for kids ages 9-12.
										We would like a coach.
										The season begins in May and we would like to start practice ASAP. We will provide snacks
										for the team.
									</div>
									<div class="right">
	...
	<script type="text/javascript" src="../lib/js/form-scripts.js"></script>
	<script type="text/javascript" src="../lib/js/home.js"></script>

	<script src="../lib/js/side-panel.js"></script>
