...
<!--[if (gt IE 9)|!(IE)]><!--><html lang="en" class="no-js"> <!--<![endif]-->
	<head>
		...
		<!-- Top Panel & Footer -->
		<link href="../demo/css/demo.css" media="screen" rel="stylesheet">
	...
	<body>
		<div class="body_wrap">
			...
			<div class="toppanel">
				<!--/ Top Panel Content -->
				<div class="toppanel_content gradient" id="toppanel_kits">
					<div class="logo"><a href="http://pixelkit.com"><img src="../demo/images/logo.png" alt="" /></a></div>

					<div class="toppanel_list">
						<ul class="clearfix" id="toppanel_list">
							<li class="gallery-item selected">
								<div class="gallery-image" style="background-image:url(http://pixelkit.com/wp-content/uploads/2013/07/ListThumbnail1.jpg)"><a href="../modern-touch/index.html" class="circle"></a></div>
								<strong>Modern Touch</strong>
							</li>
							<li class="gallery-item">
								<div class="gallery-image" style="background-image:url(http://pixelkit.com/wp-content/uploads/2013/03/ListThumb_MV.jpg)"><a href="../metro-vibes/index.html" class="circle"></a></div>
								<strong>Metro Vibes</strong>
							</li>
							<li class="gallery-item">
								<div class="gallery-image" style="background-image:url(http://pixelkit.com/wp-content/uploads/2013/05/ListThumb1.jpg)"><a href="../vanilla-cream/index.html" class="circle"></a></div>
								<strong>Vanilla Cream</strong>
							</li>
							<li class="gallery-item">
								<div class="gallery-image" style="background-image:url(http://pixelkit.com/wp-content/uploads/2013/05/ListThumb.jpg)"><a href="../dark-velvet/index.html" class="circle"></a></div>
								<strong>Dark Velvet</strong>
							</li>
							<li class="gallery-item">
								<div class="gallery-image" style="background-image:url(http://pixelkit.com/wp-content/uploads/2013/04/ListThumb.jpg)"><a href="../arctic-sunset/index.html" class="circle"></a></div>
								<strong>Arctic Sunset</strong>
							</li>
							<li class="gallery-item">
								<div class="gallery-image" style="background-image:url(http://pixelkit.com/wp-content/uploads/2013/05/ListThumb2.jpg)"><a href="../sweet-candy/index.html" class="circle"></a></div>
								<strong>Sweet Candy</strong>
							</li>
							<li class="gallery-item">
								<div class="gallery-image" style="background-image:url(http://pixelkit.com/wp-content/uploads/2013/07/ListThumbnail.jpg)"><a href="../chubby-stacks/index.html" class="circle"></a></div>
								<strong>Chubby Stacks</strong>
							</li>
							<li class="gallery-item">
								<div class="gallery-image" style="background-image:url(http://pixelkit.com/wp-content/uploads/2013/09/ListThumbnail.jpg)"><a href="../city-break/index.html" class="circle"></a></div>
								<strong>City Break</strong>
							</li>
							<li class="gallery-item">
								<div class="gallery-image" style="background-image:url(http://pixelkit.com/wp-content/uploads/2014/01/ListThumbnail.jpg)"><a href="../funky-tunes/index.html" class="circle"></a></div>
								<strong>Funky Tunes</strong>
							</li>
							<li class="gallery-item">
								<div class="gallery-image" style="background-image:url(http://pixelkit.com/wp-content/uploads/2013/11/ListThumbnail.jpg)"><a href="../skinny-frames/index.html" class="circle"></a></div>
								<strong>Skinny Frames</strong>
							</li>
						</ul>
						<a class="prev" id="toppanel_list_prev" href="#"><span>&lsaquo;</span></a>
						<a class="next" id="toppanel_list_next" href="#"><span>&rsaquo;</span></a>
					</div>
					<script>
						jQuery(document).ready(function($) {
							$('#toppanel_list').carouFredSel({
								prev : "#toppanel_list_prev",
								next : "#toppanel_list_next",
								auto: false,
								width: '100%',
								scroll: {
									items : 1
							...
							var center_items = Math.floor($("#toppanel_list").triggerHandler("configuration", "items.visible") / 2);
							$('#toppanel_list').trigger('slideTo', [$(".gallery-item.selected")]);

							// Show/Hide Map
							var toppanel_content = $(".toppanel_content");
							$(".toppanel_hidebtn").click(function(){
								if ($(this).closest(".toppanel").hasClass("panel_hide")) {
									toppanel_content.stop().animate({marginTop: 0},{queue:false, duration:550, easing: 'easeOutQuart'});
								} else {
									toppanel_content.stop().animate({marginTop: -toppanel_content.height()},{queue:false, duration:550, easing: 'easeOutQuart'});
								}
								$(this).closest(".toppanel").toggleClass("panel_hide");
							});
				...
				<div class="toppanel_pane">
					<div class="toppanel_hidebtn"></div>
				</div>
			</div>
			<!--/ Top Panel -->

			<!-- Title Box -->
			<div class="title-box modern-touch">
				<div class="inner">
					<h1>Modern Touch</h1>
					<div class="follow-buttons">
						<iframe class="github-btn" src="http://ghbtns.com/github-btn.html?user=Pixelkit&repo=PixelKit-Bootstrap-UI-Kits&type=watch&count=true" allowtransparency="true" frameborder="0" scrolling="0" width="110px" height="20px"></iframe>
						<iframe class="github-btn" src="http://ghbtns.com/github-btn.html?user=Pixelkit&repo=PixelKit-Bootstrap-UI-Kits&type=fork&count=true" allowtransparency="true" frameborder="0" scrolling="0" width="100px" height="20px"></iframe>
						<a href="https://twitter.com/share" class="twitter-share-button" data-url="http://pixelkit.com" data-text="Free Bootstrap UI Kit" data-counturl="https://github.com/Pixelkit/PixelKit-Bootstrap-UI-Kits" data-count="horizontal" data-via="pixelkitcom" data-related="pixelkitcom:PixelKit">Tweet</a>
					</div>
				</div>
			</div>
			<!--/ Title Box -->
			...
			<div class="footer-demo">
				...
				<div class="get-access">
					<h2>A premium version of this Bootstrap html kit
						<br />
				...
				<div class="bottom_buttons">
					<p>
						<a href="http://pixelkit.com/kits/flat-ui-kit" target="_blank" class="button large btn_yellow"><span>Find Out More</span></a>
					</p>
					<p>The complete kit contains more than 100 elements across 6 categories</p>
				</div>
			</div>
			<!-- Footer -->
		...
		<script>
			...
			ga('create', 'UA-15832274-19', 'pixelkit.com');
			ga('send', 'pageview');
